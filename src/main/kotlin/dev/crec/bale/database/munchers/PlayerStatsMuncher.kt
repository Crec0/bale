...
suspend fun munchPlayerStats(server: MinecraftServer) {
    ...
    DatabaseSingleton.query {
        stats.forEach { (key, subStats) ->
            ...
            subStats.jsonObject.forEach { sName, sValue ->
                ...
                insertOrUpdate(profile, statName, statValue)
            }
        }
    }
}

private fun insertOrUpdate(profile: GameProfile, statName: String, statValue: Int) {
